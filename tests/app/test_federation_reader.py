...
class FederationReaderServerTestCase(unittest.TestCase):
    """
    Tests for :class:`synapse.app.client_reader.FederationReaderServer`.
    """

    def setUp(self):
        self.config = Mock()
        self.version_string = "Synapse/Test"
        self.server = FederationReaderServer("test",
                                             config=self.config,
